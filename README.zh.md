...
查看详细的使用指南和 API 文档请移步 [VuReact 官网](https://vureact.vercel.app/)！
...
- **[运行时适配包](https://vureact-runtime.vercel.app/)**：提供 React 版的 Vue 核心 API
- **[路由适配包](https://router-vureact.vercel.app/)**：支持 Vue Router → React Router 转换
